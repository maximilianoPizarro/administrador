...
import com.administrador.app.security.SecurityUtils;
import com.administrador.app.service.MailService;
import com.administrador.app.service.UserService;
import com.administrador.app.service.dto.PasswordChangeDTO;
import com.administrador.app.service.dto.UserDTO;
import com.administrador.app.web.rest.errors.*;
import com.administrador.app.web.rest.vm.KeyAndPasswordVM;
import com.administrador.app.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public void activateAccount(@RequestParam(value = "key") String key) {
        ...
        if (!user.isPresent()) {
            throw new AccountResourceException("No se encontro el usuario con key de activación");
        }
    }
    ...
    public UserDTO getAccount() {
        return userService.getUserWithAuthorities().map(UserDTO::new)
                .orElseThrow(() -> new AccountResourceException("No se encontro el usuario"));
    }
    ...
    public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
        String userLogin = SecurityUtils.getCurrentUserLogin()
                .orElseThrow(() -> new AccountResourceException("No se encontro el login"));
        ...
        if (!user.isPresent()) {
            throw new AccountResourceException("No se encontro el usuario");
        }
    ...
    public void finishPasswordReset(@RequestBody KeyAndPasswordVM keyAndPassword) {
        ...
        if (!user.isPresent()) {
            throw new AccountResourceException("No se encontro el usuario con el key");
        }
    }

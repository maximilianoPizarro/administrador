...
import com.administrador.app.config.Constants;
...
import com.administrador.app.web.rest.errors.EmailAlreadyUsedException;
import com.administrador.app.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            throw new BadRequestAlertException("No se pudo crear el usuario con el ID", "userManagement", "idexists");
            ...
            return ResponseEntity.created(new URI("/api/users/" + newUser.getLogin()))
                    .headers(HeaderUtil.createAlert(applicationName,
                            "Usuario creado con el identificador " + newUser.getLogin(), newUser.getLogin()))
                    .body(newUser);
        }
    }
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        return ResponseUtil.wrapOrNotFound(updatedUser, HeaderUtil.createAlert(applicationName,
                "usuario actualizado con el identificador " + userDTO.getLogin(), userDTO.getLogin()));
    }
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable String login) {
        ...
        return ResponseEntity.noContent().headers(
                HeaderUtil.createAlert(applicationName, "Usuario eliminado con el identificador " + login, login))
                .build();
    }
    ...
    public ResponseEntity<Void> blanquearPasswordByAdmin(@PathVariable String login) {
        ...
        return ResponseEntity.noContent()
                .headers(HeaderUtil.createAlert(applicationName, "Blanqueo de password para el user " + login, login))
                .build();
    }
}
